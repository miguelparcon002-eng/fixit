-- ============================================
-- FIXIT APP DATA STORAGE - New Tables Only
-- Run this if local_storage already exists
-- ============================================
...
DROP POLICY IF EXISTS "Allow public read ratings" ON app_ratings;
DROP POLICY IF EXISTS "Allow public insert ratings" ON app_ratings;
DROP POLICY IF EXISTS "Allow public update ratings" ON app_ratings;
DROP POLICY IF EXISTS "Allow public delete ratings" ON app_ratings;

DROP POLICY IF EXISTS "Allow public read earnings" ON app_earnings;
DROP POLICY IF EXISTS "Allow public insert earnings" ON app_earnings;
DROP POLICY IF EXISTS "Allow public update earnings" ON app_earnings;
DROP POLICY IF EXISTS "Allow public delete earnings" ON app_earnings;

DROP POLICY IF EXISTS "Allow public read profiles" ON app_user_profiles;
DROP POLICY IF EXISTS "Allow public insert profiles" ON app_user_profiles;
DROP POLICY IF EXISTS "Allow public update profiles" ON app_user_profiles;
DROP POLICY IF EXISTS "Allow public delete profiles" ON app_user_profiles;

DROP POLICY IF EXISTS "Allow public read promo codes" ON app_promo_codes;
DROP POLICY IF EXISTS "Allow public insert promo codes" ON app_promo_codes;
DROP POLICY IF EXISTS "Allow public update promo codes" ON app_promo_codes;
DROP POLICY IF EXISTS "Allow public delete promo codes" ON app_promo_codes;
...
DROP TRIGGER IF EXISTS update_app_ratings_timestamp ON app_ratings;
DROP TRIGGER IF EXISTS update_app_earnings_timestamp ON app_earnings;
DROP TRIGGER IF EXISTS update_app_user_profiles_timestamp ON app_user_profiles;
DROP TRIGGER IF EXISTS update_app_promo_codes_timestamp ON app_promo_codes;
...
DO $$
BEGIN
    RAISE NOTICE '✅ App data tables created successfully!';
    RAISE NOTICE 'Tables: app_ratings, app_earnings, app_user_profiles, app_promo_codes, app_settings';
    RAISE NOTICE 'Promo codes seeded: WELCOME10, SAVE500, FIRSTTIME';
END $$;
