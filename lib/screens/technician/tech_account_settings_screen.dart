...
class _TechAccountSettingsScreenState
  ...
  Future<void> _loadPrefs() async {
    ...
    setState(() {
      ...
      _shareData = prefs.getBool(_kShare) ?? true;
        ...
        child: ListView(
          ...
          children: [
            ...
            _ModernTile(
              ...
              title: 'Share Data with Customers',
              subtitle: 'Allow customers to see your info',
              trailing: Switch(
                value: _shareData,
                onChanged: (value) {
...
class _ChangePasswordSheetState extends State<_ChangePasswordSheet> {
  ...
  InputDecoration _inputDec(
    ...
    return InputDecoration(
      hintText: hint,
      prefixIcon:
          Icon(prefixIcon, color: AppTheme.textSecondaryColor, size: 20),
      filled: true,
